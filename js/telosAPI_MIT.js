// telosAPI.js
// VERSION 0.8 - April 26, 2021
// MIT License 2021 - TLCC Consultants Pte. Ltd.
// https://web.tlccc.sg/defi/
...
function updateAPIServer(apiURL) {
    switch(apiURL) {
        case 'https://telos.caleos.io':
            telosAPIURL_history = "https://telos.caleos.io/v2/history/";
            telosAPIURL_history_type = "get";

            telosAPIURL_chain = "https://telos.caleos.io/v1/chain/";
            telosAPIURL_chain_type = "post";

            telosAPIURL_transact = 'https://telos.caleos.io';
            return;
        break;
        case 'https://api.telosunlimited.io':
            telosAPIURL_history = "https://api.telosunlimited.io/v2/history/";
            telosAPIURL_history_type = "get";

            telosAPIURL_chain = "https://api.telosunlimited.io/v1/chain/";
            telosAPIURL_chain_type = "post";

            telosAPIURL_transact = 'https://api.telosunlimited.io';
            return;
        break;
        case 'http://testnet.teloslogs.caleos.io':
            telosAPIURL_history = "http://testnet.teloslogs.caleos.io/v2/history/";
            telosAPIURL_history_type = "get";

            telosAPIURL_chain = "http://testnet.teloslogs.caleos.io/v1/chain/";
            telosAPIURL_chain_type = "post";

            telosAPIURL_transact = 'http://testnet.teloslogs.caleos.io';
            return;
        break;
        default:
            telosAPIURL_history = "https://telos.caleos.io/v2/history/";
...
function tlos_create_transfer_action(contract, sender, receiver, amount, unit, smemo)
{
	return {
		  ...
		  authorization: [{
			actor: sender,
			permission: $('#sign_perm').val(), //'active' normally
		  }],
		  data: {
			from: sender,
			to: receiver,
...
//
// returns - nothing
function tlos_get_table_rows(contract, limit, scope, table, upper_bound, lower_bound, funcCallback, errorCallback = function(err) {}) {
    var sURL = '';
    
    if(telosAPIURL_chain_type === "get")
    {
        sURL = telosAPIURL_chain + "get_table_rows?json=true&code=" + contract.toLowerCase() + "&limit=" + limit + "&scope=" + scope.toLowerCase() + "&table=" + table.toLowerCase() + "&upper_bound=" + upper_bound + "&lower_bound=" + lower_bound;
